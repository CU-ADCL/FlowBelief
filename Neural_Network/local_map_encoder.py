...
from Neural_Network.conditional_unet1d import ConditionalUnet1D
...
class ConditionalUnet1DWithLocalMap(nn.Module):
    def __init__(self, input_channels, encoder_name,embedding_dim,additional_global_cond_dim=14,
        ...
        self.unet = ConditionalUnet1D(
            ...
            global_cond_dim=embedding_dim + additional_global_cond_dim,
            **kwargs,
        )
