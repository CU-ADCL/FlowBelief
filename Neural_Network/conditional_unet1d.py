...
from Neural_Network.transformer import CrossAttention, SinusoidalPosEmb
...
class ConditionalUnet1D(nn.Module):
    def __init__(self,
        ...
        output_channels: Number of channels in the output sequence. Defaults to input_channels.
        global_cond_dim: Dim of global conditioning applied with FiLM
          in addition to diffusion step embedding. This is usually obs_horizon * obs_dim
        diffusion_step_embed_dim: Size of positional encoding for diffusion iteration k
        base_channels: Base hidden channel width.
        down_dims: Multipliers for each U-Net level, e.g. [1, 2, 4].
        ...
        hidden_dims = [base_channels * multiplier for multiplier in down_dims]
        all_dims = [input_channels] + hidden_dims
